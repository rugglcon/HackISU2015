...
public class Protein{
	...
	while (i < a.length()) {
		...
		// if it is a letter find corresponding amino acid
			...
			//result = result + protein(a.charAt(i));
		}
		// move on
		i++;
	}
...
//	a = a.toUpperCase();
//	// alanine check
//	if (a.equals("GCU") || a.equals("GCT") || a.equals("GCA") || a.equals("GCG")) {
//		result = result + "A";
//		return result;
//	}// serine check
//	else if (a.equals("UCT") || a.equals("UCA") || a.equals("UCU") || a.equals("UCG") || a.equals("AGU") || a.equals("AGC")) {
//		result = result + "S";
//		return result;
//	}// threonine check
//	else if (a == 't' || a == 'T') {
